# OloLabs.Promotions.ExampleAPI

This is an example API application that shows how to use OloLabs.Promotions.SDK to do the following:

- Accept incoming Promotions requests using the models in `OloLabs.Promotions.SDK.Requests`
- Send responses using the models in `OloLabs.Promotions.SDK.Responses`
...
Open `OloLabs.Promotions.ExampleAPI.sln` in the IDE of your choice, then launch it using one of the provided launch profiles.
...
2. Run the API
   1. (HTTP): `dotnet run --project .\OloLabs.Promotions.ExampleAPI\OloLabs.Promotions.ExampleAPI.csproj`
   2. (HTTPS):
`dotnet run --launch-profile https --project .\OloLabs.Promotions.ExampleAPI\OloLabs.Promotions.ExampleAPI.csproj`
